window.FROGCUP_KILLERS = {
  ...
  killers: [
    ...
    { id: "nurse", name: "ナース", image: "../assets/images/killers/nurse.webp", status: "allowed", bonusStatus: "undecided", keyRules: [{ label: "4パーク使用可能", cardLabel: "4パーク可" }, { label: "室内MAPでも使用可能", cardLabel: "室内MAP可" }], restrictions: ["アンコモン以下のみ使用可能。", "禁止スキン：「コレクターの呪い」。"] },
    ...
    { id: "blight", name: "ブライト", image: "../assets/images/killers/blight.webp", status: "allowed", bonusStatus: "undecided", keyRules: [{ label: "4パーク使用可能", cardLabel: "4パーク可" }], restrictions: ["「化合物33」は単体使用のみ。", "「玉虫色のラベル」「錬金術師の指輪」は使用禁止。"], terms: ["soloUse"] },
